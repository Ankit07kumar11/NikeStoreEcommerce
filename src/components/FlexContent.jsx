    ...
    <>
      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          ...
          <a href={url} className='flex item-center ' target={"_blank"} role="button">
            <button type="button" className="button-theme bg-slate-900 shadow-slate-9 text-slate-100 py-1.5">
              {btn}
            </button>
          </a>
        </div>

      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              className="bg-white opacity-90 blur-effect-theme button-theme py-1 shadow shadow-sky-200 text-sm"onClick={() => {onAddToCart(); onCartToggle();}}
            >
              {btn}
            </button>
          </div>
        ...
        <div
          className={`flex items-center ${
            ifExists ? "absolute top-5 right-1" : "justify-content-center"
          }`}
        >
          <img
            src={img}
            ...
            className={`transitions-theme hover:-rotate-12 ${
              ifExists
                ? "h-auto w-64 lg:w-w-56 md:w-48 -rotate-[35deg]"
                : "h-36 w-64 "
            }`}
          />
        </div>
